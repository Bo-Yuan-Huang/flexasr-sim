...
univ_var_745 = (sc_biguint<12>(local_var_18), sc_biguint<8>(Child_GBLayerNorm_gb_layer_norm_cntr_vector));
sc_biguint<20> local_var_20 = 256;
sc_biguint<20> local_var_21 = (univ_var_745 * local_var_20);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_layer_norm_sum_vector_level_prep state updates:" << std::endl;
