...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_core_run_mac_out_14 state updates:" << std::endl;
instr_update_log << "    PE1_CORE_CHILD_PE1_core_accum_vector_14 => " << std::hex << "0x" << PE1_CORE_CHILD_PE1_core_accum_vector_14 << std::endl; 
