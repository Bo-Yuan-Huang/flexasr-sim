...
univ_var_747 = (sc_biguint<15>(local_var_14), sc_biguint<5>(Child_GBLayerNorm_gb_layer_norm_cntr_byte));
sc_biguint<20> local_var_16 = (Child_GBLayerNorm_gb_layer_norm_vector_base_addr + univ_var_747);
univ_var_748 = (sc_biguint<12>(local_var_12), sc_biguint<20>(local_var_16));
auto local_var_18 = flex_gb_core_large_buffer[univ_var_748];
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_layer_norm_sum_byte_op state updates:" << std::endl;
