...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE0_CONFIG_CLUSTER_TABLE_FIRST state updates:" << std::endl;
instr_update_log << "    flex_pe0_cluster_table_first_Entry0 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry0 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry1 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry1 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry10 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry10 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry11 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry11 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry12 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry12 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry13 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry13 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry14 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry14 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry15 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry15 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry2 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry2 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry3 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry3 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry4 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry4 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry5 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry5 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry6 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry6 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry7 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry7 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry8 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry8 << std::endl; 
instr_update_log << "    flex_pe0_cluster_table_first_Entry9 => " << std::hex << "0x" << flex_pe0_cluster_table_first_Entry9 << std::endl; 
