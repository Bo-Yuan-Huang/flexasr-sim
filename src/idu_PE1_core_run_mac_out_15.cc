...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_core_run_mac_out_15 state updates:" << std::endl;
instr_update_log << "    PE1_CORE_CHILD_PE1_core_accum_vector_15 => " << std::hex << "0x" << PE1_CORE_CHILD_PE1_core_accum_vector_15 << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_child_run_mac_cntr => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_child_run_mac_cntr << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_child_run_mac_flag => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_child_run_mac_flag << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_run_mac_child_state => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_run_mac_child_state << std::endl; 
