...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE3_CONFIG_CLUSTER_TABLE_SECOND state updates:" << std::endl;
instr_update_log << "    flex_pe3_cluster_table_second_Entry0 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry0 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry1 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry1 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry10 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry10 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry11 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry11 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry12 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry12 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry13 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry13 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry14 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry14 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry15 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry15 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry2 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry2 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry3 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry3 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry4 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry4 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry5 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry5 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry6 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry6 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry7 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry7 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry8 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry8 << std::endl; 
instr_update_log << "    flex_pe3_cluster_table_second_Entry9 => " << std::hex << "0x" << flex_pe3_cluster_table_second_Entry9 << std::endl; 
