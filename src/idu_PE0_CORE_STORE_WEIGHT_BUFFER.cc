...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE0_CORE_STORE_WEIGHT_BUFFER state updates:" << std::endl;
instr_update_log << "    flex_pe0_core_weight_buffer get updated" << std::endl;
