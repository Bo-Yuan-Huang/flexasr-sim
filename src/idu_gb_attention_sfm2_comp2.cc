...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_sfm2_comp2 state updates:" << std::endl;
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_10 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_10 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_11 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_11 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_8 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_8 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_9 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_9 << std::endl; 
