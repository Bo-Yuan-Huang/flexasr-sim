...
auto& univ_var_114 = local_var_13;
return univ_var_114;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE2_core_run_mac_out_13 state updates:" << std::endl;
instr_update_log << "    PE2_CORE_CHILD_PE2_core_accum_vector_13 => " << std::hex << "0x" << PE2_CORE_CHILD_PE2_core_accum_vector_13 << std::endl; 
instr_update_log << "    PE2_CORE_CHILD_pe2_core_child_run_mac_cntr => " << std::hex << "0x" << PE2_CORE_CHILD_pe2_core_child_run_mac_cntr << std::endl; 
instr_update_log << "    PE2_CORE_CHILD_pe2_core_child_run_mac_flag => " << std::hex << "0x" << PE2_CORE_CHILD_pe2_core_child_run_mac_flag << std::endl; 
instr_update_log << "    PE2_CORE_CHILD_pe2_core_run_mac_child_state => " << std::hex << "0x" << PE2_CORE_CHILD_pe2_core_run_mac_child_state << std::endl; 
