...
bool local_var_17 = (local_var_15 == flex_gb_attention_num_timestep_1);
bool local_var_18 = (local_var_15 > flex_gb_attention_num_timestep_1);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_child_bmm_next state updates:" << std::endl;
