...
auto& univ_var_100 = local_var_10;
return univ_var_100;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE2_core_run_mac_mul state updates:" << std::endl;
instr_update_log << "    PE2_CORE_RUN_MAC_CHILD_pe2_core_run_mac_child_result_temp => " << std::hex << "0x" << PE2_CORE_RUN_MAC_CHILD_pe2_core_run_mac_child_result_temp << std::endl; 
