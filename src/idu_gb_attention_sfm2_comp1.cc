...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_sfm2_comp1 state updates:" << std::endl;
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_4 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_4 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_5 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_5 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_6 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_6 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_7 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_7 << std::endl; 
