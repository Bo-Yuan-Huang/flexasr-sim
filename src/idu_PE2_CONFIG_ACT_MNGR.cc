...
auto& univ_var_852 = local_var_9;
return univ_var_852;
}
void flex::update_flex_PE2_CONFIG_ACT_MNGR() {
auto local_var_1 = flex_data_in_2.range(2, 0);
auto local_var_1_nxt_holder = local_var_1;
univ_var_853 = (sc_biguint<8>(flex_data_in_7), sc_biguint<8>(flex_data_in_6));
auto univ_var_853_nxt_holder = univ_var_853;
...
flex_pe2_act_mngr_buffer_addr_base = univ_var_853_nxt_holder;
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE2_CONFIG_ACT_MNGR state updates:" << std::endl;
instr_update_log << "    flex_pe2_act_mngr_adpfloat_bias => " << std::hex << "0x" << flex_pe2_act_mngr_adpfloat_bias << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_buffer_addr_base => " << std::hex << "0x" << flex_pe2_act_mngr_buffer_addr_base << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_is_valid => " << std::hex << "0x" << flex_pe2_act_mngr_is_valid << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_is_zero_first => " << std::hex << "0x" << flex_pe2_act_mngr_is_zero_first << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_num_inst => " << std::hex << "0x" << flex_pe2_act_mngr_num_inst << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_num_output => " << std::hex << "0x" << flex_pe2_act_mngr_num_output << std::endl; 
instr_update_log << "    flex_pe2_act_mngr_output_addr_base => " << std::hex << "0x" << flex_pe2_act_mngr_output_addr_base << std::endl; 
