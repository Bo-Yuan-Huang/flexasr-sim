...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_sfm2_comp0 state updates:" << std::endl;
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_0 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_0 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_1 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_1 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_2 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_2 << std::endl; 
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_3 => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_3 << std::endl; 
