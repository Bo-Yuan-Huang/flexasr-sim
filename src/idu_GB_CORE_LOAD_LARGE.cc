#include <flex.h>
bool flex::decode_flex_GB_CORE_LOAD_LARGE() {
...
void flex::update_flex_GB_CORE_LOAD_LARGE() {
...
sc_biguint<32> local_var_5 = 5242880;
...
auto local_var_15 = flex_gb_core_large_buffer[local_var_14];
...
auto local_var_18 = flex_gb_core_large_buffer[local_var_17];
...
auto local_var_24 = flex_gb_core_large_buffer[local_var_23];
...
auto local_var_27 = flex_gb_core_large_buffer[local_var_26];
...
auto local_var_54 = flex_gb_core_large_buffer[local_var_53];
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "GB_CORE_LOAD_LARGE state updates:" << std::endl;
