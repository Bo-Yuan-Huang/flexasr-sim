...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_core_is_start state updates:" << std::endl;
instr_update_log << "    flex_pe1_act_reg_port_valid => " << std::hex << "0x" << flex_pe1_act_reg_port_valid << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_is_start => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_is_start << std::endl; 
instr_update_log << "    flex_pe1_core_state => " << std::hex << "0x" << flex_pe1_core_state << std::endl; 
