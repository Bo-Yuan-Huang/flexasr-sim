...
flex_gb_layer_norm_num_timestep_1 = univ_var_812_nxt_holder;
flex_gb_layer_norm_num_vector_1 = flex_data_in_6_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "CONFIG_GB_LAYER_NORM state updates:" << std::endl;
instr_update_log << "    flex_gb_layer_norm_adpbias_1 => " << std::hex << "0x" << flex_gb_layer_norm_adpbias_1 << std::endl; 
instr_update_log << "    flex_gb_layer_norm_adpbias_3 => " << std::hex << "0x" << flex_gb_layer_norm_adpbias_3 << std::endl; 
instr_update_log << "    flex_gb_layer_norm_adpbias_4 => " << std::hex << "0x" << flex_gb_layer_norm_adpbias_4 << std::endl; 
instr_update_log << "    flex_gb_layer_norm_is_valid => " << std::hex << "0x" << flex_gb_layer_norm_is_valid << std::endl; 
instr_update_log << "    flex_gb_layer_norm_memory_index_1 => " << std::hex << "0x" << flex_gb_layer_norm_memory_index_1 << std::endl; 
instr_update_log << "    flex_gb_layer_norm_mode => " << std::hex << "0x" << flex_gb_layer_norm_mode << std::endl; 
instr_update_log << "    flex_gb_layer_norm_num_timestep_1 => " << std::hex << "0x" << flex_gb_layer_norm_num_timestep_1 << std::endl; 
instr_update_log << "    flex_gb_layer_norm_num_vector_1 => " << std::hex << "0x" << flex_gb_layer_norm_num_vector_1 << std::endl; 
