...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE2_act_child_op_store state updates:" << std::endl;
instr_update_log << "    flex_pe2_act_buffer get updated" << std::endl;
