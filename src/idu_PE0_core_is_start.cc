...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE0_core_is_start state updates:" << std::endl;
instr_update_log << "    flex_pe0_act_reg_port_valid => " << std::hex << "0x" << flex_pe0_act_reg_port_valid << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_pe0_core_is_start => " << std::hex << "0x" << PE0_CORE_CHILD_pe0_core_is_start << std::endl; 
