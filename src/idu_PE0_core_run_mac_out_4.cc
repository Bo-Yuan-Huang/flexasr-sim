...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE0_core_run_mac_out_4 state updates:" << std::endl;
instr_update_log << "    PE0_CORE_CHILD_PE0_core_accum_vector_4 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_accum_vector_4 << std::endl; 
