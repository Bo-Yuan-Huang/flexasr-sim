...
auto& univ_var_456 = local_var_14;
return univ_var_456;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE3_act_child_op_inpe state updates:" << std::endl;
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_0 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_0 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_1 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_1 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_10 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_10 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_11 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_11 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_12 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_12 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_13 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_13 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_14 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_14 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_15 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_15 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_2 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_2 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_3 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_3 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_4 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_4 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_5 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_5 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_6 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_6 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_7 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_7 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_8 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_8 << std::endl; 
instr_update_log << "    PE3_ACT_CHILD_PE3_act_reg_temp_9 => " << std::hex << "0x" << PE3_ACT_CHILD_PE3_act_reg_temp_9 << std::endl; 
instr_update_log << "    flex_pe3_act_reg_port_valid => " << std::hex << "0x" << flex_pe3_act_reg_port_valid << std::endl; 
