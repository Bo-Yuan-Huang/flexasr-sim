...
auto& univ_var_145 = local_var_13;
return univ_var_145;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE3_core_run_mac_out_6 state updates:" << std::endl;
instr_update_log << "    PE3_CORE_CHILD_PE3_core_accum_vector_6 => " << std::hex << "0x" << PE3_CORE_CHILD_PE3_core_accum_vector_6 << std::endl; 
