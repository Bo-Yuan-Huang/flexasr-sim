...
univ_var_750 = (sc_biguint<16>(local_var_3), sc_biguint<8>(flex_gb_layer_norm_num_vector_1));
sc_biguint<24> local_var_6 = 16;
sc_biguint<24> local_var_7 = (univ_var_750 * local_var_6);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_layer_norm_mean_op state updates:" << std::endl;
...
instr_update_log << "    Child_GBLayerNorm_gb_layer_norm_inv_std => " << std::hex << "0x" << Child_GBLayerNorm_gb_layer_norm_inv_std << std::endl; 
instr_update_log << "    Child_GBLayerNorm_gb_layer_norm_mean => " << std::hex << "0x" << Child_GBLayerNorm_gb_layer_norm_mean << std::endl; 
