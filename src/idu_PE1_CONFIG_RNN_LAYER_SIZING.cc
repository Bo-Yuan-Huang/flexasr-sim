...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_CONFIG_RNN_LAYER_SIZING state updates:" << std::endl;
instr_update_log << "    flex_pe1_rnn_layer_sizing_is_bias => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_is_bias << std::endl; 
instr_update_log << "    flex_pe1_rnn_layer_sizing_is_cluster => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_is_cluster << std::endl; 
instr_update_log << "    flex_pe1_rnn_layer_sizing_is_valid => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_is_valid << std::endl; 
instr_update_log << "    flex_pe1_rnn_layer_sizing_is_zero_first => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_is_zero_first << std::endl; 
instr_update_log << "    flex_pe1_rnn_layer_sizing_num_manager => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_num_manager << std::endl; 
instr_update_log << "    flex_pe1_rnn_layer_sizing_num_output => " << std::hex << "0x" << flex_pe1_rnn_layer_sizing_num_output << std::endl; 
