...
auto& univ_var_106 = local_var_13;
return univ_var_106;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE2_core_run_mac_out_5 state updates:" << std::endl;
instr_update_log << "    PE2_CORE_CHILD_PE2_core_accum_vector_5 => " << std::hex << "0x" << PE2_CORE_CHILD_PE2_core_accum_vector_5 << std::endl; 
