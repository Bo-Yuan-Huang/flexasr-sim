...
univ_var_752 = (sc_biguint<12>(local_var_12), sc_biguint<8>(Child_GBLayerNorm_gb_layer_norm_cntr_vector));
sc_biguint<20> local_var_14 = 256;
sc_biguint<20> local_var_15 = (univ_var_752 * local_var_14);
...
univ_var_753 = (sc_biguint<4>(local_var_17), sc_biguint<16>(flex_gb_core_mem_mngr_small_base_small_6));
sc_biguint<20> local_var_20 = 4;
sc_biguint<20> local_var_21 = (univ_var_753 << local_var_20);
sc_biguint<20> local_var_22 = 16;
sc_biguint<20> local_var_23 = (univ_var_752 * local_var_22);
sc_biguint<20> local_var_24 = (local_var_21 + local_var_23);
auto local_var_24_nxt_holder = local_var_24;
sc_biguint<4> local_var_26 = 0;
univ_var_754 = (sc_biguint<16>(flex_gb_core_mem_mngr_small_base_small_5), sc_biguint<4>(local_var_26));
sc_biguint<20> local_var_28 = 16;
sc_biguint<20> local_var_29 = (univ_var_752 * local_var_28);
sc_biguint<20> local_var_30 = (univ_var_754 + local_var_29);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_layer_norm_norm_vector_prep state updates:" << std::endl;
...
instr_update_log << "    Child_GBLayerNorm_gb_layer_norm_vector_base_addr => " << std::hex << "0x" << Child_GBLayerNorm_gb_layer_norm_vector_base_addr << std::endl; 
instr_update_log << "    Child_GBLayerNorm_gb_layer_norm_vector_level_base_addr_beta => " << std::hex << "0x" << Child_GBLayerNorm_gb_layer_norm_vector_level_base_addr_beta << std::endl; 
instr_update_log << "    Child_GBLayerNorm_gb_layer_norm_vector_level_base_addr_gamma => " << std::hex << "0x" << Child_GBLayerNorm_gb_layer_norm_vector_level_base_addr_gamma << std::endl; 
