...
flex_gb_control_num_timestep_1 = univ_var_796_nxt_holder;
flex_gb_control_num_vector_1 = flex_data_in_6_nxt_holder;
flex_gb_control_num_vector_2 = flex_data_in_7_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "CONFIG_GB_CONTROL state updates:" << std::endl;
instr_update_log << "    flex_gb_control_is_rnn => " << std::hex << "0x" << flex_gb_control_is_rnn << std::endl; 
instr_update_log << "    flex_gb_control_is_valid => " << std::hex << "0x" << flex_gb_control_is_valid << std::endl; 
instr_update_log << "    flex_gb_control_memory_index_1 => " << std::hex << "0x" << flex_gb_control_memory_index_1 << std::endl; 
instr_update_log << "    flex_gb_control_memory_index_2 => " << std::hex << "0x" << flex_gb_control_memory_index_2 << std::endl; 
instr_update_log << "    flex_gb_control_mode => " << std::hex << "0x" << flex_gb_control_mode << std::endl; 
instr_update_log << "    flex_gb_control_num_timestep_1 => " << std::hex << "0x" << flex_gb_control_num_timestep_1 << std::endl; 
instr_update_log << "    flex_gb_control_num_vector_1 => " << std::hex << "0x" << flex_gb_control_num_vector_1 << std::endl; 
instr_update_log << "    flex_gb_control_num_vector_2 => " << std::hex << "0x" << flex_gb_control_num_vector_2 << std::endl; 
