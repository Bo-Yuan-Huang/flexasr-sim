...
auto& univ_var_144 = local_var_13;
return univ_var_144;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE3_core_run_mac_out_5 state updates:" << std::endl;
instr_update_log << "    PE3_CORE_CHILD_PE3_core_accum_vector_5 => " << std::hex << "0x" << PE3_CORE_CHILD_PE3_core_accum_vector_5 << std::endl; 
