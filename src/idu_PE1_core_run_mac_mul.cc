...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_core_run_mac_mul state updates:" << std::endl;
instr_update_log << "    PE1_CORE_RUN_MAC_CHILD_pe1_core_run_mac_child_result_temp => " << std::hex << "0x" << PE1_CORE_RUN_MAC_CHILD_pe1_core_run_mac_child_result_temp << std::endl; 
