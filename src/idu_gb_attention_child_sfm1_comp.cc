...
sc_biguint<16> local_var_7 = (GB_ATTENTION_CHILD_gb_attention_timestep_cntr + local_var_6);
bool local_var_9 = (local_var_7 == flex_gb_attention_num_timestep_1);
bool local_var_10 = (local_var_7 > flex_gb_attention_num_timestep_1);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_child_sfm1_comp state updates:" << std::endl;
