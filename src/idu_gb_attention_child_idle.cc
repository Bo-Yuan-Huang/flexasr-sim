...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "gb_attention_child_idle state updates:" << std::endl;
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_max_value => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_max_value << std::endl; 
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_sum_exp => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_sum_exp << std::endl; 
...
instr_update_log << "    GB_ATTENTION_CHILD_gb_attention_vector_cntr => " << std::hex << "0x" << GB_ATTENTION_CHILD_gb_attention_vector_cntr << std::endl; 
