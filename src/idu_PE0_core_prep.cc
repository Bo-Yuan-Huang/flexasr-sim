...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE0_core_prep state updates:" << std::endl;
...
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_0 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_0 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_1 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_1 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_10 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_10 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_11 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_11 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_12 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_12 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_13 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_13 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_14 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_14 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_15 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_15 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_2 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_2 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_3 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_3 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_4 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_4 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_5 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_5 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_6 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_6 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_7 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_7 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_8 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_8 << std::endl; 
instr_update_log << "    PE0_CORE_CHILD_PE0_core_act_vector_reg_9 => " << std::hex << "0x" << PE0_CORE_CHILD_PE0_core_act_vector_reg_9 << std::endl; 
