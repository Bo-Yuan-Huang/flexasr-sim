...
univ_var_86 = (sc_biguint<8>(local_var_2), sc_biguint<8>(PE1_CORE_CHILD_pe1_core_input_counter));
...
sc_biguint<16> local_var_11 = (univ_var_86 + local_var_10);
...
univ_var_87 = (sc_biguint<8>(local_var_15), sc_biguint<8>(PE1_CORE_CHILD_pe1_core_output_counter));
...
univ_var_88 = (sc_biguint<8>(local_var_18), sc_biguint<8>(local_var_23));
sc_biguint<16> local_var_25 = (univ_var_87 * univ_var_88);
sc_biguint<16> local_var_26 = (local_var_25 + univ_var_86);
...
sc_biguint<16> local_var_35 = (univ_var_87 * univ_var_88);
sc_biguint<16> local_var_36 = (local_var_35 + univ_var_86);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE1_core_mac state updates:" << std::endl;
...
instr_update_log << "    PE1_CORE_CHILD_pe1_core_child_run_mac_input_base_vector => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_child_run_mac_input_base_vector << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_child_run_mac_weight_base_vector => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_child_run_mac_weight_base_vector << std::endl; 
instr_update_log << "    PE1_CORE_CHILD_pe1_core_input_counter => " << std::hex << "0x" << PE1_CORE_CHILD_pe1_core_input_counter << std::endl; 
