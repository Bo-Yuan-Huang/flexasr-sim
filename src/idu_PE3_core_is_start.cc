...
auto& univ_var_159 = local_var_14;
return univ_var_159;
}
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "PE3_core_is_start state updates:" << std::endl;
instr_update_log << "    flex_pe3_act_reg_port_valid => " << std::hex << "0x" << flex_pe3_act_reg_port_valid << std::endl; 
instr_update_log << "    PE3_CORE_CHILD_pe3_core_is_start => " << std::hex << "0x" << PE3_CORE_CHILD_pe3_core_is_start << std::endl; 
instr_update_log << "    flex_pe3_core_state => " << std::hex << "0x" << flex_pe3_core_state << std::endl; 
